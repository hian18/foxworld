...
am__theforgottenserver_SOURCES_DIST = account.cpp account.h \
	actions.cpp actions.h admin.cpp admin.h allocator.cpp \
	allocator.h baseevents.cpp baseevents.h beds.cpp beds.h \
	chat.cpp chat.h combat.cpp combat.h condition.cpp condition.h \
	config.h configmanager.cpp configmanager.h connection.cpp \
	connection.h const.h container.cpp container.h creature.cpp \
	creature.h creatureevent.cpp creatureevent.h cylinder.cpp \
	cylinder.h database.cpp database.h databasemanager.cpp \
	databasemanager.h databasemysql.cpp databasemysql.h \
	databasesqlite.cpp databasesqlite.h databasepgsql.cpp \
	...
	globalevent.h gui.cpp gui.h house.cpp house.h housetile.cpp \
	housetile.h inputbox.cpp inputbox.h ioban.cpp ioban.h \
	ioguild.cpp ioguild.h iologindata.cpp iologindata.h iomap.cpp \
	iomapserialize.cpp iomapserialize.h item.cpp item.h items.cpp \
...
am_theforgottenserver_OBJECTS = account.$(OBJEXT) actions.$(OBJEXT) \
	$(am__objects_1) allocator.$(OBJEXT) baseevents.$(OBJEXT) \
	...
	$(am__objects_6) globalevent.$(OBJEXT) gui.$(OBJEXT) \
	...
	items.$(OBJEXT) luascript.$(OBJEXT) mailbox.$(OBJEXT) \
	map.$(OBJEXT) md5.$(OBJEXT) monster.$(OBJEXT) \
	monsters.$(OBJEXT) movement.$(OBJEXT) networkmessage.$(OBJEXT) \
	npc.$(OBJEXT) otserv.$(OBJEXT) outfit.$(OBJEXT) \
	outputmessage.$(OBJEXT) party.$(OBJEXT) playerbox.$(OBJEXT) \
	player.$(OBJEXT) position.$(OBJEXT) protocol.$(OBJEXT) \
	protocolgame.$(OBJEXT) protocollogin.$(OBJEXT) \
	protocolold.$(OBJEXT) quests.$(OBJEXT) raids.$(OBJEXT) \
	rsa.$(OBJEXT) scheduler.$(OBJEXT) scriptmanager.$(OBJEXT) \
	server.$(OBJEXT) sha1.$(OBJEXT) spawn.$(OBJEXT) \
	spells.$(OBJEXT) status.$(OBJEXT) talkaction.$(OBJEXT) \
	tasks.$(OBJEXT) teleport.$(OBJEXT) textlogger.$(OBJEXT) \
...
am__depfiles_remade = ./$(DEPDIR)/account.Po ./$(DEPDIR)/actions.Po \
	./$(DEPDIR)/admin.Po ./$(DEPDIR)/allocator.Po \
	./$(DEPDIR)/baseevents.Po ./$(DEPDIR)/beds.Po \
	./$(DEPDIR)/chat.Po ./$(DEPDIR)/combat.Po \
	...
	./$(DEPDIR)/globalevent.Po ./$(DEPDIR)/gui.Po \
	./$(DEPDIR)/house.Po ./$(DEPDIR)/housetile.Po \
	./$(DEPDIR)/inputbox.Po ./$(DEPDIR)/ioban.Po \
	./$(DEPDIR)/ioguild.Po ./$(DEPDIR)/iologindata.Po \
	./$(DEPDIR)/iomap.Po ./$(DEPDIR)/iomapserialize.Po \
	./$(DEPDIR)/item.Po ./$(DEPDIR)/items.Po \
...
ACLOCAL = ${SHELL} /home/hian/tibao/0.3.1/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/hian/tibao/0.3.1/missing autoconf
AUTOHEADER = ${SHELL} /home/hian/tibao/0.3.1/missing autoheader
AUTOMAKE = ${SHELL} /home/hian/tibao/0.3.1/missing automake-1.16
AWK = gawk
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lmysqlclient -lboost_date_time -lboost_system -lboost_regex -lgmp  -lxml2
LTLIBOBJS = 
LUA_CFLAGS = -I/usr/include/lua5.1
LUA_LIBS = -llua5.1
MAKEINFO = ${SHELL} /home/hian/tibao/0.3.1/missing makeinfo
...
XML_LIBS = -lxml2
abs_builddir = /home/hian/tibao/0.3.1
abs_srcdir = /home/hian/tibao/0.3.1
abs_top_builddir = /home/hian/tibao/0.3.1
abs_top_srcdir = /home/hian/tibao/0.3.1
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/hian/tibao/0.3.1/install-sh
...
include ./$(DEPDIR)/account.Po # am--include-marker
